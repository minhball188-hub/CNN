...
# --- THIẾT LẬP ---
R_out = 50.0; R_in = 20.0; resolution = 1000 # Tăng độ phân giải lên 600 cho mịn hơn (có thể tăng lên 800 nếu máy đủ mạnh)
...
# Tự động lưu ảnh sau mỗi lần chạy
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
image_filename = f"rotor_design_{timestamp}.png"
